        ...
        _setupListeners: function () {
            for (var i=0; i < this.telemetryEvents.length; i++) {
                ...
                if (event.checkParent)  {
                    $(this.domNode).parent().find(event.clickSelector).click(dojoLang.hitch(this, this._buttonClicked, event));
                } else {
                    $(event.clickSelector).click(dojoLang.hitch(this, this._buttonClicked, event));
                }      
            }
        },
